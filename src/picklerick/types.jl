mutable struct PickleRick
    ...
    function PickleRick(obstacle_positions, obstacle_radii, joint_positions, 
                        joint_velocities, goal_position)
        time_step = 10E-4
        ...
        new(obstacle_positions, obstacle_radii, joint_positions, 
            ...
            task_maps, θᵣ, time_step, m_links, m_head, nothing, priorities, max_range)
    end
end